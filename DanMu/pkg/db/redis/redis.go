...
func (slf *RedisDB) Do(commandName string, args ...interface{}) (res interface{}, err error) {
	c := slf._c.Get()
	defer c.Close()
	res, err = c.Do(commandName, args...)
	return
}
...
func (slf *RedisDB) PubSubConn()redis.PubSubConn{
	slf._ps = redis.PubSubConn{slf._c.Get()}
	return slf._ps
}

func (slf *RedisDB)Publish(channel,massage interface{})(err error) {
	_, err = slf.Do("Publish", channel, massage)
	if err != nil {
		return
	}
	return
...
//@Method Initial
//@Return (error) if connecting fail return error ,success return nil
func (slf *RedisDB) Initial(options interface{}) error {
